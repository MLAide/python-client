...
def test_create_run_should_raise_error_when_status_code_is_not_200(client, httpx_mock):
    # arrange
    httpx_mock.add_response(method='POST',
                            url='https://mlaide.com/projects/project key/runs',
                            match_headers=client.get_headers(),
    ...
    # act
    with pytest.raises(run_api.ApiResponseError):
...
def test_partial_update_run_should_raise_error_when_status_code_is_not_204(client, httpx_mock):
    # arrange
    httpx_mock.add_response(method='PATCH',
                            url='https://mlaide.com/projects/project key/runs/38',
                            match_headers={'x-api-key': 'xyz', 'content-type': 'application/merge-patch+json'},
...
def test_update_run_parameters_should_raise_error_when_status_code_is_not_204(client, httpx_mock):
    # arrange
    httpx_mock.add_response(method='PATCH',
                            url='https://mlaide.com/projects/project key/runs/38/parameters',
                            match_headers={'x-api-key': 'xyz', 'content-type': 'application/merge-patch+json'},
...
def test_update_run_metrics_should_raise_error_when_status_code_is_not_204(client, httpx_mock):
    # arrange
    httpx_mock.add_response(method='PATCH',
                            url='https://mlaide.com/projects/project key/runs/38/metrics',
                            match_headers={'x-api-key': 'xyz', 'content-type': 'application/merge-patch+json'},
