...
async def list_projects(*, client: Client,) -> Union[Projects, Error]:
...
async def create_project(*, client: Client, json_body: Project,) -> Union[Project, Error]:
...
async def show_project_by_id(*, client: Client, project_id: str,) -> Union[Project, None, Error]:
